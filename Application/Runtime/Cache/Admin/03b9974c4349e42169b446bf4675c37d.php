...
<body>
<div class="pd-20">
    <form action="/Admin/Cate/special_category_edit" method="post" class="form form-horizontal" id="form-category-add" enctype="multipart/form-data">
                    ...
                    <div class="formControls col-9">
                        <div class="uploader-thum-container">
                            ...
                            <?php if(!empty($data["img_url"])): ?><div class="form-group" id="div_user_logo">
                                <img src="<?php echo (substr($data["img_url"],1)); ?>" class="img-rect" id="img_user_logo" style="width: 320px;height: 192px;">
                            </div><?php endif; ?>
                        </div>
                    </div>
                </div>
