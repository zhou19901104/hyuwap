...
<body>
<div class="pd-20">
    <form action="/Admin/Doctor/doctor_add" method="post" class="form form-horizontal" id="form-doctor-add" enctype="multipart/form-data">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-2"> <span class="select-box">
				<select name="ment_id" class="select">
                  ...
                  <?php if(is_array($ment_list)): foreach($ment_list as $key=>$val): ?><option value="<?php echo ($val["mid"]); ?>"><?php echo ($val["class_name"]); ?></option><?php endforeach; endif; ?>
                </select>
				</span>
             </div>
            ...
            <div class="formControls col-2">
                <input type="text" class="input-text" value="0" placeholder="请输入医生顺序" name="sort">
            </div>
       ...
       <div class="row cl">
            ...
            <div class="formControls col-10">
                <input type="text" class="input-text" placeholder="请输入医生的职称" name="tech">
            </div>
        </div>
 <!--      <div class="row cl">
            <label class="form-label col-2">擅长项目：</label>
            <div class="formControls col-10">
                <textarea name="item" cols="" rows="" class="textarea"  placeholder="项目输入以' - '隔开" datatype="*10-100" dragonfly="true" nullmsg="项目不能为空！" onKeyUp="textarealength(this,200)"></textarea>
        ...
        <!--   <div class="row cl">
         <label class="form-label col-2">文章作者：</label>
            ...
            <div class="row cl">
                <label class="form-label col-2">医生图片：</label>
                <div class="formControls col-10">
        ...
        <label class="form-label col-2">缩略图：</label>
            <div class="formControls col-10">
                ...
                <input type="file" name="img_url" value="浏览..." id="exampleInputImg">
                    ...
                    <img  class="img-rect" id="img_user_logo" style="width: 340px;height: 180px;">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <textarea id="editor" name="message" style="width:100%;height:400px;"></textarea>
            </div>
        </div>
        <div class="row cl">
