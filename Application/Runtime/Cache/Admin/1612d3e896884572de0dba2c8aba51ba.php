...
<body>
<div class="pd-20">
    <form action="/Admin/Cate/special_category_add" method="post" class="form form-horizontal" id="form-category-add" enctype="multipart/form-data">
                    ...
                    <div class="formControls col-9">
                        <div class="uploader-thum-container">
                            ...
                            <div class="form-group" id="div_user_logo">
                                <img  class="img-rect" id="img_user_logo" style="width: 320px;height: 192px;">
                            </div>
                        </div>
                    </div>
                </div>
       ...
       <!--         <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-6">
                        <input type="text" class="input-text" id="cate-level" value="1" name="level">
                    </div>
                    <div class="col-3"> </div>
                </div>
