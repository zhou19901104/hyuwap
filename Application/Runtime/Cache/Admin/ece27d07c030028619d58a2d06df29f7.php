...
<body>
<div class="pd-20">
    <form action="/Admin/News/news_add" method="post" class="form form-horizontal" id="news-article-add" enctype="multipart/form-data">
        <div class="row cl">
...
<!--        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <input type="text" class="input-text"  placeholder="请输入文章关键词" name="keyword">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-2">文章摘要：</label>
            <div class="formControls col-10">
                <textarea name="description" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="摘要不能为空！" onKeyUp="textarealength(this,200)"></textarea>
