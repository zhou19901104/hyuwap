...
<div class="pd-20 text-c">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a class="btn btn-primary radius" onclick="special_category_add('添加分类','special_category_add')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加分类</a></span> <span class="r">共有数据：<strong><?php echo ($count); ?></strong> 条</span> </div>
    <div class="mt-20">
      ...
      <!--      <tr class="text-c">
                ...
                <td class="f-14"><a title="编辑" href="javascript:;" onclick="system_category_edit('栏目编辑','system-category-add.html','2','700','480')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> <a title="删除" href="javascript:;" onclick="special_category_del(this,'2')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
            </tr>
            <tr class="text-c">
                <td><input type="checkbox" name="" value=""></td>
                <td>3</td>
...
//    });
    /*系统-栏目-添加*/
    function special_category_add(title,url,w,h){
        layer_show(title,url,w,h);
    }
    /*系统-栏目-编辑*/
    function special_category_edit(title,url,id,w,h){
        layer_show(title,url + '/id/' + id,w,h);
    }
    /*系统-栏目-删除*/
    function special_category_del(obj,id){

        layer.confirm('确认要删除此分类吗？',function(index){

            $.ajax({
                url : '/Admin/Cate/special_category_del',
                data : {'id' : id},
                type : 'get',
                dataType : 'json',
