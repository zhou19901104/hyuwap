...
<body>
<div class="pd-20">
    <form action="/Admin/Special/special_add" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-2"> <span class="select-box">
				<select name="pid" class="select">
                    ...
                    <?php if(is_array($cateData)): foreach($cateData as $key=>$val): ?><option value="<?php echo ($val["id"]); ?>">|<?php echo (str_repeat('--',$val["level"])); echo ($val["cate_name"]); ?></option><?php endforeach; endif; ?>
                </select>
				</span>
            </div>
        ...
        <img  class="img-rect" id="img_user_logo" style="width: 342px;height: 192px;">
        </div>
        </div>
        </div>
        </div>
