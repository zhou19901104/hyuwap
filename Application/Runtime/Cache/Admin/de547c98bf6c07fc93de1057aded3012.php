...
<body>
<div class="pd-20">
    <form action="/Admin/Case/case_add" method="post" class="form form-horizontal" id="form-article-add" enctype="multipart/form-data">

        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>案例标题：</label>
            ...
            <div class="formControls col-10">
                <div class="uploader-thum-container">
                    ...
                    <div class="form-group" id="div_user_logo">
                        <img  class="img-rect" id="img_user_logo" style="width: 150px;height: 150px;">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row cl">
            <label class="form-label col-2">案例内容：</label>
            <div class="formControls col-10">
