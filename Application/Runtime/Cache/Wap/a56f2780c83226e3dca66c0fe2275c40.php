...
<head>
	...
	<link rel="stylesheet" href="<?php echo C('CSS_URL');?>/anli.css">
</head>
<body>
<div class="container">
	<!--header-->
	...
	<div class="main">
		...
		<div class="anli-list clearfix" id="anli1">
			<div class="content-list clearfix">
				<div class="content-title">
					<p class="title-cn"><i>整形美容案例</i></p>
					<p class="title-zh">PLASTIC BEAUTY CASE</p>
				</div>

				<div class="case-list">
					<ul>
						<li class="show"><img src="<?php echo C('IMG_URL');?>/zxmr-01.jpg" alt=""></li>
						<li><img src="<?php echo C('IMG_URL');?>/zxmr-02.jpg" alt=""></li>
						<li><img src="<?php echo C('IMG_URL');?>/zxmr-03.jpg" alt=""></li>
					</ul>
				</div>
			</div>
			<!--<div class="case-show">-->
				<!--<ul>-->
					<!--<li class="active"><img src="<?php echo C('IMG_URL');?>/zxmr-011.jpg" alt=""></li>-->
					<!--<li><img src="<?php echo C('IMG_URL');?>/zxmr-022.jpg" alt=""></li>-->
					<!--<li><img src="<?php echo C('IMG_URL');?>/zxmr-033.jpg" alt=""></li>-->
				<!--</ul>-->
			<!--</div>-->
		</div>

		<div class="anli-list clearfix" id="anli2">
			<div class="content-list clearfix">
				<div class="content-title">
					<p class="title-cn"><i>微整形案例</i></p>
					<p class="title-zh">PLASTIC BEAUTY CASE</p>
				</div>

				<div class="case-list">
					<ul>
						<li class="show"><img src="<?php echo C('IMG_URL');?>/wzx-01.jpg" alt=""></li>
						<li><img src="<?php echo C('IMG_URL');?>/wzx-02.jpg" alt=""></li>
						<li><img src="<?php echo C('IMG_URL');?>/wzx-03.jpg" alt=""></li>
					</ul>
				</div>
			</div>
			<!--<div class="case-show">-->
				<!--<ul>-->
					<!--<li class="active"><img src="<?php echo C('IMG_URL');?>/wzx-011.jpg" alt=""></li>-->
					<!--<li><img src="<?php echo C('IMG_URL');?>/wzx-022.jpg" alt=""></li>-->
					<!--<li><img src="<?php echo C('IMG_URL');?>/wzx-033.jpg" alt=""></li>-->
				<!--</ul>-->
			<!--</div>-->
		</div>

		<div class="anli-list clearfix" id="anli3">
			<div class="content-list clearfix">
				<div class="content-title">
					<p class="title-cn"><i>皮肤美容案例</i></p>
					<p class="title-zh">PLASTIC BEAUTY CASE</p>
				</div>

				<div class="case-list">
					<ul>
						<li class="show"><img src="<?php echo C('IMG_URL');?>/pfmr-01.jpg" alt=""></li>
						<li><img src="<?php echo C('IMG_URL');?>/pfmr-02.jpg" alt=""></li>
						<li><img src="<?php echo C('IMG_URL');?>/pfmr-03.jpg" alt=""></li>
					</ul>
				</div>
			</div>
			<!--<div class="case-show">-->
				<!--<ul>-->
					<!--<li class="active"><img src="<?php echo C('IMG_URL');?>/pfmr-011.jpg" alt=""></li>-->
					<!--<li><img src="<?php echo C('IMG_URL');?>/pfmr-022.jpg" alt=""></li>-->
					<!--<li><img src="<?php echo C('IMG_URL');?>/pfmr-033.jpg" alt=""></li>-->
				<!--</ul>-->
			<!--</div>-->
		</div>
...
<script type="text/javascript" src="<?php echo C('JS_URL');?>/anli.js"></script>
