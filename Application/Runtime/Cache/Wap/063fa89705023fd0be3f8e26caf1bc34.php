...
<head>
    ...
    <link rel="stylesheet" href="<?php echo C('CSS_URL');?>/empty.css">
    <style>
    ...
    <div class="main">
        ...
        <div class="main-nav">
            <div class="nav-colnum">
                <ul>
                    <li><a href="<?php echo U('Web/index');?>"><img src="<?php echo C('IMG_URL');?>/nav-1.png"><p>首页</p></a></li>
                    <li><a href="<?php echo U('Web/company');?>"><img src="<?php echo C('IMG_URL');?>/nav-2.png"><p>品牌</p></a></li>
                    <li><a href="<?php echo U('Web/index/#item-list');?>"><img src="<?php echo C('IMG_URL');?>/nav-3.png"><p>项目</p></a></li>
                    <li><a href="<?php echo U('Web/case');?>"><img src="<?php echo C('IMG_URL');?>/nav-4.png"><p>案例</p></a></li>
        ...
        <div class="main-content">
            <img src="/Public/Uploads/empty/404.jpg">
        </div>
...
<script type="text/javascript" src="<?php echo C('JS_URL');?>/empty.js"></script>
